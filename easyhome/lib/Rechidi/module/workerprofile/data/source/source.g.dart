...
class _WorkerProfileDataSource implements WorkerProfileDataSource {
  ...
  @override
  Future<_SwitchResponse> switchAccount() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<_SwitchResponse>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = _SwitchResponse.fromJson(_result.data!);
    return value;
  }
